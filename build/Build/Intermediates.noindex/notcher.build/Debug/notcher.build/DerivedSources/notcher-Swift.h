...
#ifndef NOTCHER_SWIFT_H
#define NOTCHER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="notcher",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC7notcher11AppDelegate")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC7notcher20MouseTrackingManager")
@interface MouseTrackingManager : NSResponder
...
SWIFT_CLASS("_TtC7notcher10NotchPanel")
